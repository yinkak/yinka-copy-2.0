...
public interface UsersService {
    UserModel registerUser(String login, String password, String email, String name /*String gender, String dob, String location, int phoneNumber, String pictureUpload*/);
